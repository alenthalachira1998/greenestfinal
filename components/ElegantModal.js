               ...
               */}
                ...
                <div className="mt-2">
                  ...
                  <div className="grid sm:gap-4 sm:grid-cols-4 md:grid-cols-4  grid-cols-2  p-2 lg:p-4   lg:gap-8  justify-center">
                    ...
                    <div className="    flex justify-center items-center flex-col  text-white font-semibold md:mt-4 lg:mt-8 mb-2 "> <img className=" shadow-xl max-w-4xl rounded-full h-20 w-20   object-cover  lg:w-36 lg:h-36" src="../images/Pi7compressedTreehouse-min.jpg" ></img><p className=" pt-2 text-xs md:text sm text-center break-normal lg:text-sm">Tree House</p></div>
                    <div className="   pt-4 flex justify-center items-center flex-col  text-white font-semibold md:mt-4 lg:mt-8 mb-2 "> <img className=" shadow-xl max-w-4xl rounded-full h-20 w-20 object-cover  lg:w-36 lg:h-36" src="../images/Pi7compressednature..jpg" ></img><p className="  text-xs md-text sm text-center break-normal lg:text-sm">Work from <br /> Nature  Zone</p></div>
                    <div className="    flex justify-center items-center flex-col  text-white font-semibold md:mt-4 lg:mt-8 mb-2 "> <img className=" shadow-xl max-w-4xl rounded-full h-20 w-20 object-cover  lg:w-36 lg:h-36" src="../images/Pi7compressedPond&waterfall.jpg" ></img><p className=" pt-2 text-xs md:text sm text-center break-normal lg:text-sm">Recreational Pond <br /> and waterfall</p></div>
                    <div className="    flex justify-center items-center flex-col  text-white font-semibold md:mt-4 lg:mt-8 mb-2 "> <img className=" shadow-xl max-w-4xl rounded-full h-20 w-20 object-cover  lg:w-36 lg:h-36" src="../images/build.jpg" ></img><p className=" pt-2 text-xs md-text sm text-center break-normal lg:text-sm">Only 33% building <br />Footprint</p></div>
                    <div className="    flex justify-center items-center flex-col  text-white font-semibold md:mt-4 lg:mt-8 mb-2 "> <img className=" shadow-xl max-w-4xl rounded-full h-20 w-20 object-cover  lg:w-36 lg:h-36" src="../images/Pi7compressedInfinitypond.jpg" ></img><p className=" pt-2 text-xs md:text sm text-center break-normal lg:text-sm">Infinity Pond and <br /> Sunset Deck</p></div>
                    <div className="    flex justify-center items-center flex-col  text-white font-semibold md:mt-4 lg:mt-8 mb-2 "> <img className=" shadow-xl max-w-4xl rounded-full h-20 w-20 object-cover  lg:w-36 lg:h-36" src="../images/Pi7compressedmiawakiforest.jpg" ></img><p className=" pt-2 text-xs md-:ext sm text-center break-normal lg:text-sm">Miawaki Fruit <br />Forest</p></div>
                    <div className="    flex justify-center items-center flex-col  text-white font-semibold md:mt-4 lg:mt-8 mb-2 "> <img className=" shadow-xl max-w-4xl rounded-full h-20 w-20 object-cover  lg:w-36 lg:h-36" src="../images/Pi7compressedclubhouse.jpg" ></img><p className=" pt-2 text-xs md:text sm text-center break-normal lg:text-sm">Fully Equipped Club House <br /> and waterfall</p></div>
                    <div className="    flex justify-center items-center flex-col  text-white font-semibold md:mt-4 lg:mt-8 "> <img className=" shadow-xl max-w-4xl rounded-full h-20 w-20  object-cover  lg:w-36 lg:h-36 contrast-200 saturate-125" src="../images/transplanted.jpg" ></img><p className=" pt-2 text-xs md:text sm text-center break-normal lg:text-sm">20 + Transplanted <br /> Elder Trees</p></div>

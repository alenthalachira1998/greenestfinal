               ...
               */}
                                ...
                                <div className="mt-2">
                                    ...
                                    <div className="grid sm:gap-4 sm:grid-cols-3 md:grid-cols-3  grid-cols-2  p-2 lg:p-3   lg:gap-8  justify-center">
                                        ...
                                        <div className="    flex justify-center items-center flex-col text-white font-semibold md:mt-4 lg:mt-8 mb-2 "> <img className=" shadow-xl max-w-4xl rounded-full h-20 w-20   object-cover  lg:w-36 lg:h-36" src="../images/solar-energy-market-1562318641.jpeg" ></img><p className=" pt-2 text-xs md:text sm text-center break-normal lg:text-sm">100%Solar Energy <br />Certification</p></div>
                                        <div className="    flex justify-center items-center flex-col text-white font-semibold md:mt-4 lg:mt-8 mb-2 "> <img className=" shadow-xl max-w-4xl rounded-full h-20 w-20 object-cover  lg:w-36 lg:h-36" src="../images/maintanence.jpg" ></img><p className="  text-xs md-text sm text-center break-normal lg:text-sm"> Excellent <br />No monthly <br />Maintenance</p></div>
                                        <div className="    flex justify-center items-center flex-col text-white font-semibold md:mt-4 lg:mt-8 mb-2 "> <img className=" shadow-xl max-w-4xl rounded-full h-20 w-20 object-cover  lg:w-36 lg:h-36" src="../images/water.jpg" ></img><p className=" pt-2 text-xs md:text sm text-center break-normal lg:text-sm">70 % water<br /> recycling </p></div>
                                        <div className="    flex justify-center items-center flex-col text-white font-semibold md:mt-4 lg:mt-8 mb-2 "> <img className=" shadow-xl max-w-4xl rounded-full h-20 w-20 object-cover  lg:w-36 lg:h-36" src="../images/ev2.jpg" ></img><p className=" pt-2 text-xs md:text sm text-center break-normal lg:text-sm">Electric Vehicle<br /> Fast charging <br />stations </p></div>
                                        <div className="    flex justify-center items-center flex-col text-white font-semibold md:mt-4 lg:mt-8 mb-2 "> <img className=" shadow-xl max-w-4xl rounded-full h-20 w-20 object-cover  lg:w-36 lg:h-36 bg-white" src="../images/bulb-160207.svg" ></img><p className=" pt-2 text-xs md-:ext sm text-center break-normal lg:text-sm">Energy<br /> Management System</p></div>
                                        <div className="    flex justify-center items-center flex-col text-white font-semibold md:mt-4  lg:mt-8 mb-2 "> <img className=" shadow-xl max-w-4xl rounded-full h-20 w-20 object-cover bg-gray-300 lg:w-36 lg:h-36" src="../images/smart-city-bw-11-512 (1).png" ></img><p className=" pt-2 text-xs md:text sm text-center break-normal lg:text-sm">Water <br /> Management system</p></div>

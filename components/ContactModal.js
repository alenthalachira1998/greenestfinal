                ...
                <div className=" align-middle mt-2">
                 ...
                 <div className="">
                    ...
                    <div className="flex justify-end">
                       <button
                    type="button"
                    className="inline-flex justify-center text-white  bg-green-700  hover:bg-green-400  overflow-hidden text-left align-middle    relative   px-2   py-2 text-xs md:text-sm font-medium     "
                    onClick={closeModal}
                  >
                    close
                  </button>

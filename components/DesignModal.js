            ...
            >
               ...
               */}
                ...
                <div className="mt-2">
                  ...
                  <div className="grid sm:gap-4 sm:grid-cols-2 md:grid-cols-2  grid-cols-2  p-2 lg:p-3   lg:gap-8  justify-center">

                    <div className="    flex justify-center items-center flex-col text-white font-semibold hover:transform scale-75 md:mt-4 lg:mt-8 mb-2 "> <img className=" shadow-xl max-w-4xl rounded-full h-20 w-20   object-cover  lg:w-36 lg:h-36" src="../images/56712366-conceptual-vector-passive-house-in-heat-or-summer-icon-and-pictogram-modern-flat-design-illustration.jpg" ></img><p className=" pt-2 text-xs md:text sm text-center break-normal lg:text-sm">Passive<br/> Architecture </p></div>
                    <div className="    flex justify-center items-center flex-col text-white font-semibold hover:transform scale-75 md:mt-4 lg:mt-8 mb-2 "> <img className=" shadow-xl max-w-4xl rounded-full h-20 w-20 object-cover  lg:w-36 lg:h-36" src="../images/idp.jpeg" ></img><p className="  text-xs md-text sm text-center break-normal lg:text-sm"> Integrated <br/> Designing <br/>  Process (IDP)</p></div>
                    <div className="    flex justify-center items-center flex-col text-white font-semibold hover:transform scale-75 md:mt-4 lg:mt-8 mb-2 "> <img className=" shadow-xl max-w-4xl rounded-full h-20 w-20 object-cover  lg:w-36 lg:h-36" src="../images/bio2.jpg" ></img><p className=" pt-2 text-xs md:text sm text-center break-normal lg:text-sm">Biophilic Design</p></div>
                    <div className="    flex justify-center items-center flex-col text-white font-semibold hover:transform scale-75 md:mt-4 lg:mt-8 mb-2 "> <img className=" shadow-xl max-w-4xl rounded-full h-20 w-20 object-cover  lg:w-36 lg:h-36" src="../images/IGBC platinum.jpg" ></img><p className=" pt-2 text-xs md:text sm text-center break-normal lg:text-sm">Indian Greeen <br/> Building Council (IGBC) Certified</p></div>

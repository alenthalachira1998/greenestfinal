...
export default function ImprovedModal(props) {
               ...
               */}
                ...
                <div className="mt-2">
                  ...
                  <div className="grid sm:gap-4 sm:grid-cols-3 md:grid-cols-3  grid-cols-2  p-2 lg:p-3   lg:gap-8  justify-center">
                    ...
                    <div className="    flex justify-center items-center flex-col  text-white font-semibold md:mt-4 lg:mt-8 mb-2 "> <img className=" shadow-xl max-w-4xl rounded-full h-20 w-20   object-cover  lg:w-36 lg:h-36" src="../images/IGBC platinum.jpg" ></img><p className=" pt-2 text-xs md:text sm text-center break-normal lg:text-sm">IGBC Platinum <br/>Certification</p></div>
                    <div className="    flex justify-center items-center flex-col  text-white font-semibold md:mt-4 lg:mt-8 mb-2 "> <img className=" shadow-xl max-w-4xl rounded-full h-20 w-20 object-cover  lg:w-36 lg:h-36" src="../images/day.jpg" ></img><p className="  text-xs md-text sm text-center break-normal lg:text-sm"> Excellent <br/>Daylighting</p></div>
                    <div className="    flex justify-center items-center flex-col  text-white font-semibold md:mt-4 lg:mt-8 mb-2 "> <img className=" shadow-xl max-w-4xl rounded-full h-20 w-20 object-cover  lg:w-36 lg:h-36" src="../images/air.jpg" ></img><p className=" pt-2 text-xs md:text sm text-center break-normal lg:text-sm">Improved Air  <br /> Quality</p></div>
                    <div className="    flex justify-center items-center flex-col  text-white font-semibold md:mt-4 lg:mt-8 mb-2 "> <img className=" shadow-xl max-w-4xl rounded-full h-20 w-20 object-cover  lg:w-36 lg:h-36" src="../images/smart securty.jpg" ></img><p className=" pt-2 text-xs md:text sm text-center break-normal lg:text-sm">Smart <br /> Secutity  </p></div>
                    <div className="    flex justify-center items-center flex-col  text-white font-semibold md:mt-4 lg:mt-8 mb-2 "> <img className=" shadow-xl max-w-4xl rounded-full h-20 w-20 object-cover  lg:w-36 lg:h-36" src="../images/quality.jpg" ></img><p className=" pt-2 text-xs md-:ext sm text-center break-normal lg:text-sm">External Quality <br/>Assurance</p></div>
                    <div className="    flex justify-center items-center flex-col  text-white font-semibold md:mt-4 lg:mt-8 mb-2 "> <img className=" shadow-xl max-w-4xl rounded-full h-20 w-20 object-cover  lg:w-36 lg:h-36" src="../images/bio.jpeg" ></img><p className=" pt-2 text-xs md:text sm text-center break-normal lg:text-sm">Biophilic Design <br /> Approch </p></div>

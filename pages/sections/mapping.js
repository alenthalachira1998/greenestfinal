...
<div className="flex flex font-Open text-sm mt-4 w-full h-full justify-around">
...
<div className="flex flex font-Open text-sm mt-4 w-full h-full items-center  justify-center">
...
<div className="flex text-sm px-2 py-1  font-sans hover:bg-gray-200  focus:bg-gray-200 bg-white rounded-lg">

           ...
           <div className="flex flex-col h-full w-screen">
               ...
               <div className="  hidden justify-center transform rotate-180 items-center vtext lg:flex lg:m-4 xl:ml-0 2xl:ml-2  w-10 md:w-36">
                ...
                <h1 className="text-gray-300 xl:font-bold 2xl:text-8xl xl:text-6xl  desk:text-7xl sm:text-5xl md:text-6xl font-medium  text-center  ">  
                  ...
                  < div className=" 2xl:w-3/12  lg:ml-20  desk:m-20 2xl:m-16 xl:w-24 lg:w-24 w-16  desk:w-24 lg:flex flex-col hidden  justify-center  items-start xl:items-center text-center">
                        <h2 className="lg:font-semibold xl:font-medium desk:text-6xl lg:text-5xl  2xl:text-7xl pb-4" style={{color:'#59a23e'}}>Improved </h2>
                        <h2 className="lg:font-semibold xl:font-medium desk:text-6xl  lg:text-5xl  2xl:text-7xl pb-4" style={{color:'#59a23e'}}>Quality</h2>
                        <h2 className="lg:font-semibold xl:font-medium desk:text-6xl  lg:text-5xl  2xl:text-7xl pb-4" style={{color:'#59a23e'}}>of</h2>
                        <h2 className="lg:font-semibold xl:font-medium desk:text-6xl  lg:text-5xl  2xl:text-7xl" style={{color:'#59a23e'}}>Space</h2>
                    ...
                    <div className="  flex-grow    flex   lg:items-center items-start ">
                        ...
                        <div className=" mt-14 md:mt-28 lg:hidden absolute w-full  text-center "><h1 className=" md:text-2xl text-base xs:text-xl font-bold"  style={{color:'#59a23e'}}>IMPROVED QUALITY OF <span className="">SPACE</span></h1></div>
                            ...
                            <div className="  flex justify-center 2xl:w-auto  xl:h-48 2xl:h-72 desk:h-60 flex-col text-gray-700 2xl-mb-8 lg:mb-4 xl:mt-24  "> <img className=" shadow-xl resize-none  rounded-2xl border-2xl   h-full w-full     object-cover   " src="../images/resort/featurepic/Page - 04 Improved-03-min.jpg" ></img><p className="text-xs xs:text-sm text-center whitespace-nowrap 2xl:text-lg    lg:text-base lg:pt-2">Improved Air  <br /> Quality</p></div>

           ...
           <div className="flex flex-col h-screen w-screen">
                <div className="flex h-screen w-screen   ">
                    ...
                    <div className=" 2xl:w-3/12 lg:ml-16 xl:w-80 lg:w-56 w-16  lg:flex flex-col hidden  justify-center  items-start xl:items-center text-center">
                        <h2 className="lg:font-semibold xl:font-medium lg:text-5xl xl:text-6xl 2xl:text-7xl pb-4" style={{color:'#59a23e'}}>Improved </h2>
                        <h2 className="lg:font-semibold xl:font-medium   lg:text-5xl xl:text-6xl 2xl:text-7xl pb-4" style={{color:'#59a23e'}}>Quality</h2>
                        <h2 className="lg:font-semibold xl:font-medium   lg:text-5xl xl:text-6xl 2xl:text-7xl pb-4" style={{color:'#59a23e'}}>of</h2>
                        <h2 className="lg:font-semibold xl:font-medium   lg:text-5xl xl:text-6xl 2xl:text-7xl" style={{color:'#59a23e'}}>Space</h2>
                    ...
                    <div className="  flex-grow    flex   lg:items-center items-start ">
                        ...
                        <div className=" mt-14 md:mt-28 lg:hidden absolute w-full  text-center "><h1 className=" md:text-2xl text-base xs:text-xl font-bold"  style={{color:'#59a23e'}}>IMPROVED QUALITY OF <span className="">SPACE</span></h1></div>
                            <div className="  flex justify-center 2xl max-w-80 2xl:h-80 flex-col text-gray-700 2xl-mb-8 lg:mb-4 hover:transform scale-75 xl:mt-24 mt-20 md:mt-36 "> <img className=" shadow-xl resize-none  rounded-2xl border-2xl   h-full w-full     object-cover   " src="../images/resort/featurepic/Page - 04 Improved-01-min1.png" ></img><p className=" text-xs xs:text-sm text-center  hitespace-nowrap  lg:text-sm lg:pt-2">IGBC Platinum <br/>Certification</p></div>
                            <div className="  flex justify-center 2xl max-w-80 2xl:h-80 flex-col text-gray-700 2xl-mb-8 lg:mb-4 hover:transform scale-75 xl:mt-24 mt-20 md:mt-36 "> <img className=" shadow-xl resize-none  rounded-2xl border-2xl   h-full w-full     object-cover   " src="../images/resort/featurepic/Page - 04 Improved-02-min.jpg" ></img><p className="text-xs xs:text-sm text-center whitespace-nowrap  lg:text-sm lg:pt-2">Excellent <br/>Daylighting  </p></div>
                            <div className="  flex justify-center 2xl max-w-80 2xl:h-80 flex-col text-gray-700 2xl-mb-8 lg:mb-4 hover:transform scale-75 xl:mt-24  "> <img className=" shadow-xl resize-none  rounded-2xl border-2xl   h-full w-full     object-cover   " src="../images/resort/featurepic/Page - 04 Improved-03-min.jpg" ></img><p className="text-xs xs:text-sm text-center whitespace-nowrap  lg:text-sm lg:pt-2">Improved Air  <br /> Quality</p></div>
                            <div className="  flex justify-center 2xl max-w-80 2xl:h-80 flex-col text-gray-700  hover:transform scale-75   xl:mb-10 "> <img className="shadow-xl resize-none  rounded-2xl border-2xl   h-full w-full     object-cover    " src="../images/resort/featurepic/Page - 04 Improved-04 1.png" ></img><p className="text-xs xs:text-sm text-center  whitespace-nowrap   lg:text-sm lg:pt-2">Smart <br /> Secutity </p></div>
                            <div className="  flex justify-center 2xl max-w-80 2xl:h-80 flex-col text-gray-700  hover:transform scale-75   mb-16  xl:mb-10"> <img className=" shadow-xl resize-none  rounded-2xl border-2xl   h-full w-full     object-cover   " src="../images/resort/featurepic/Page - 04 Improved-06-min.png" ></img><p className="text-xs xs:text-sm text-center   lg:text-sm lg:pt-2 whitespace-nowrap">External Quality <br/>Assurance</p></div>
                            <div className="  flex justify-center 2xl max-w-80 2xl:h-80 flex-col text-gray-700  hover:transform scale-75   mb-16  xl:mb-10 "> <img className=" shadow-xl resize-none  rounded-2xl border-2xl   h-full w-full     object-cover   " src="../images/resort/featurepic/Page - 04 Improved-05-min.jpg" ></img><p className="text-xs xs:text-sm text-center whitespace-nowrap  lg:text-sm lg:pt-2">Biophilic Design <br /> Approch</p></div>

           ...
           <div className="flex flex-col h-screen w-screen">
                <div className="flex h-screen w-screen   ">
                    ...
                    <div className=" 2xl:w-3/12 lg:ml-16 xl:w-80 lg:w-56 w-16  lg:flex flex-col hidden  justify-center  items-start xl:items-center text-center">
                        <h2 className="lg:font-semibold xl:font-medium lg:text-5xl xl:text-6xl 2xl:text-7xl sm:pb-2" style={{color:'#59a23e'}}>Resort </h2>
                        <h2 className="lg:font-semibold xl:font-medium   lg:text-5xl xl:text-6xl 2xl:text-7xl" style={{color:'#59a23e'}}>Living </h2>

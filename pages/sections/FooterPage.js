...
const FooterPage = () => {
    ...
    return (
        <>
        <div className="lg:hidden flex-col   flex lg:h-screen h-full w-screen ">
            ...
            <div className="flex sm:flex-row  sm:bg-white flex-col w-screen  h-full justify-start md:justify-between lg:px-20  ">
                <div className="text-sm  ml-4 lg:ml-0 mt-12  md:mt-8 text-gray-900 sm:text-base lg:text-xl"> <h1 className="font-medium text-sm sm:text-base lg:text-2xl" >Contact us</h1><div>
       ...
       <div className='lg:flex hidden flex-col  mt-20 justify-center'>
           <div className='hidden lg:h-screen lg:flex' style={bg}><div className="flex-col pl-6 mt-3 text-white text-2xl  flex">  
          ...
          <div className= "lg:flex hidden  w-screen justify-between px-10 items-center pb-10 h-52">
          <div className="text-sm  ml-4 lg:ml-0 mt-8  md:mt-4 text-gray-900 sm:text-base lg:text-xl"> <h1 className="font-medium text-sm sm:text-base lg:text-2xl" >Contact us</h1><div>
                    <p >Greenest Buildings and Business Pvt Ltd,</p><p>
                        Nandavanam</p><p> Thiruvananthapuram - 695033</p>  <p className="flex"> <FaPhoneAlt className="mr-2" />0471-2991231, 8078079111</p><p className="flex"><AiOutlineMail className="mr-4" />mail@greenest.co.in</p></div></div>
        ...
        <div className= "">        <img src='/images/resort/Page - 04 Improved-01.jpg' className='lg:h-36 hidden lg:flex sm:h-28 h-24  self-center ' />      </div>
          </div>
       </div>

            ...
            <div className="flex h-screen w-screen   ">
              ...
              <div className="  flex-grow    flex   lg:items-center items-center ">
                <div className="grid mx-6 lg:mx-28  relative  md:mt-0 sm:gap-2 landscape1:grid-cols-3 sm:grid-cols-2 md:grid-cols-2 xl:grid-cols-3 xs:grid-cols-2 grid-cols-2  h-screen xs:h-full w-11/12 sm:h-full xs:w-11/12  lg:h-3/4  sm:w-11/12 2xl:w-11/12 md:w-11/12  xl:h-11/12 2xl:h-full  p-4 gap-2   lg:content-center content-center  lg:gap-4  ">
                  ...
                  <div className=" flex justify-center flex-col text-gray-700 hover:transform scale-75  "> <Link href="sections/Gallery/image5"><a><img className=" shadow-xl resize-none rounded-2xl border-2xl h-full w-full object-cover " src="../images/resort/gallery/Page - 03-06.jpg" ></img></a></Link></div>
                  <div className=" flex justify-center flex-col text-gray-700 hover:transform scale-75 "> <Link href="sections/Gallery/image6"><a> <img className=" shadow-xl resize-none rounded-2xl border-2xl h-full w-full object-cover " src="../images/resort/Page - 03-03-min.jpg" ></img></a></Link></div>
                  <div className=" flex justify-center flex-col text-gray-700 hover:transform scale-75  "><Link href="sections/Gallery/image7"><a><img className=" shadow-xl resize-none rounded-2xl border-2xl h-full w-full object-cover " src="../images/resort/Work from Nature_6_11zon.jpg" ></img> </a></Link></div>
            ...
            <div className="flex h-screen w-screen ">
              ...
              <div className=" flex-grow flex lg:items-center items-center ">
                <div className="grid lg:mx-28  h-screen relative md:mt-0 sm:gap-2 mx-6 md:mx-0 landscape1:grid-cols-3 sm:grid-cols-2 md:grid-cols-2 xl:grid-cols-3 xs:grid-cols-2 grid-cols-2   w-11/12 sm:h-full xs:w-11/12 lg:h-3/4 sm:w-11/12 2xl:w-11/12 md:w-11/12 xl:h-11/12 2xl:h-full p-4 gap-2 lg:content-center content-center lg:gap-4 ">
                  ...
                  <div className="grid col-span-2 lg:col-span-3  mb-4 self-center  font-medium text-center xl:text-left md:text-3xl text-xl xs:text-xl " style={{ color: '#59a23e' }}>Gallery </div>
                  <div className=" flex justify-center flex-col text-gray-700 hover:transform scale-75   "> <Link href="sections/Gallery/image1"><a><img className=" shadow-xl resize-none rounded-2xl border-2xl h-full w-full object-cover " src="../images/resort/Page - 06 Green policy-06-min.jpg" ></img></a></Link></div>
                  <div className=" flex justify-center flex-col text-gray-700 hover:transform scale-75  "> <Link href="sections/Gallery/image2"><a><img className=" shadow-xl resize-none rounded-2xl border-2xl h-full w-full object-cover " src="../images/resort/gallery/Page - 06 Green policy-05.jpg" ></img></a></Link></div>
                  <div className=" flex justify-center flex-col text-gray-700 hover:transform scale-75 row-span-2    sm:mb-0"> <iframe className=" shadow-xl resize-none rounded-2xl border-2xl h-full w-full object-cover " src="https://www.youtube.com/embed/TjOALPVpDNo" ></iframe></div>

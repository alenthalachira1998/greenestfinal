...
<div className=" text-gray-800 mt-36 3xl:mt-72 lg:text-xl 3xl:text-9xl  2xl:mt-38 tb:text-2xl  xl:text-2xl  2xl:text-3xl  text-sm  2xl:font-normal flex flex-col items-center justify-center  " >

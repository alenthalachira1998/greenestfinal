...
<span className="text-white  z-20 absolute  text-center bottom-8 sm:bottom:4  w-screen  lg:text-8xl text-6xl  font-thin"><IoIosArrowRoundDown className="w-screen animate-bounce" /></span>
</div>
</div>
